Если Вы это читаете, значит, Вы получили мое резюме. В репозитории на данный момент находится один пример законченной программы на Python, где можно ознакомиться с кодом (игра Arkanoid). 
